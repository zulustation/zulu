...
# and the subkey tool (either standalone or included as "key" command in zulu binary)
...
export PARACHAIN_IMAGE="zulustation/zulu-node-parachain:sha-8ea9683"
...
export VALIDATOR_IMAGE="zulustation/zulu-relay-chain:sha-6d85246"
...
curl -o $RELAY_CHAIN_SPEC_FILE https://raw.githubusercontent.com/zulustation/polkadot/battery-station-relay/node/service/res/battery-station-relay.json
