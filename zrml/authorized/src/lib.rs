...
mod pallet {
    use crate::{weights::WeightInfoZulu, AuthorizedPalletApi};
    ...
    T: crate::Config,
{
    ...
    use zulu_primitives::types::{Asset, MarketBonds, ScoringRule};

    zulu_primitives::types::Market {
        base_asset: Asset::Zul,
        creation: zulu_primitives::types::MarketCreation::Permissionless,
        creator_fee: 0,
        creator: T::PalletId::get().into_account_truncating(),
        market_type: zulu_primitives::types::MarketType::Scalar(0..=100),
        dispute_mechanism: zulu_primitives::types::MarketDisputeMechanism::Authorized,
        metadata: Default::default(),
        oracle: T::PalletId::get().into_account_truncating(),
        period: zulu_primitives::types::MarketPeriod::Block(Default::default()),
        deadlines: zulu_primitives::types::Deadlines {
        ...
        status: zulu_primitives::types::MarketStatus::Disputed,
