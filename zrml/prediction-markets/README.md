...
currency (ZUL) at a 1:1 exchange rate, meaning that 1 ZUL is used to generate 1
...
exchange, being used to exchange 1:1 back to ZUL.
...
advisory committee, the on-chain governing body of Zulu that is responsible
