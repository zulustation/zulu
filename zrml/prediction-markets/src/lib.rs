...
mod pallet {
    ...
    use {orml_traits::asset_registry::Inspect, zulu_primitives::types::CustomMetadata};
    ...
    use zulu_primitives::{
        ...
        traits::{DisputeApi, DisputeResolutionApi, Swaps, ZuluAssetManager},
        types::{
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn admin_destroy_market(
            ...
            // https://github.com/zulustation/runtime-audit-1/issues/34#issuecomment-1120187097 for
            // details.
    ...
    pub trait Config: frame_system::Config + zrml_market_commons::Config {
        ...
        type AssetManager: ZuluAssetManager<
            Self::AccountId,
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn on_resolution(
            ...
            // TODO: https://github.com/zulustation/zulu/issues/815
