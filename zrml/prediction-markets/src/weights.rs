...
impl<T: frame_system::Config> WeightInfoZulu for WeightInfo<T> {
    ...
    fn admin_destroy_disputed_market(a: u32, d: u32, _o: u32, c: u32, r: u32) -> Weight {
        Weight::from_ref_time(36_524_000)
            // Standard Error: 41_000
            .saturating_add(Weight::from_ref_time(28_980_000).saturating_mul(a.into()))
            // Standard Error: 473_000
            .saturating_add(Weight::from_ref_time(40_066_000).saturating_mul(d.into()))
            // Standard Error: 41_000
            .saturating_add(Weight::from_ref_time(425_000).saturating_mul(c.into()))
            // Standard Error: 41_000
    ...
    fn admin_destroy_reported_market(a: u32, _o: u32, c: u32, _r: u32) -> Weight {
        Weight::from_ref_time(302_448_000)
            // Standard Error: 39_000
            .saturating_add(Weight::from_ref_time(27_690_000).saturating_mul(a.into()))
            // Standard Error: 39_000
            .saturating_add(Weight::from_ref_time(809_000).saturating_mul(c.into()))
    ...
    fn admin_move_market_to_closed(_o: u32, c: u32) -> Weight {
        Weight::from_ref_time(62_951_000)
            // Standard Error: 2_000
            .saturating_add(Weight::from_ref_time(69_000).saturating_mul(c.into()))
    ...
    fn admin_move_market_to_resolved_scalar_reported(_r: u32) -> Weight {
        Weight::from_ref_time(107_834_000)
            .saturating_add(T::DbWeight::get().reads(4))
    ...
    // Storage: PredictionMarkets Disputes (r:0 w:1)
    fn admin_move_market_to_resolved_categorical_reported(r: u32) -> Weight {
        Weight::from_ref_time(171_263_000)
            // Standard Error: 4_000
            .saturating_add(Weight::from_ref_time(12_000).saturating_mul(r.into()))
    ...
    fn admin_move_market_to_resolved_scalar_disputed(_r: u32) -> Weight {
        Weight::from_ref_time(174_434_000)
    ...
    // Storage: Swaps Pools (r:1 w:1)
    fn admin_move_market_to_resolved_categorical_disputed(r: u32) -> Weight {
        Weight::from_ref_time(226_823_000)
            // Standard Error: 4_000
            .saturating_add(Weight::from_ref_time(85_000).saturating_mul(r.into()))
    ...
    // Storage: Balances Reserves (r:1 w:1)
    fn approve_market() -> Weight {
        Weight::from_ref_time(71_421_000)
    ...
    fn request_edit(r: u32) -> Weight {
        Weight::from_ref_time(40_894_000)
            // Standard Error: 0
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn buy_complete_set(a: u32) -> Weight {
        Weight::from_ref_time(79_725_000)
            // Standard Error: 25_000
            .saturating_add(Weight::from_ref_time(19_896_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(a.into())))
    ...
    fn create_market(m: u32) -> Weight {
        Weight::from_ref_time(80_436_000)
            // Standard Error: 3_000
            .saturating_add(Weight::from_ref_time(9_000).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(4))
    }
    // Storage: PredictionMarkets MarketIdsForEdit (r:1 w:1)
    ...
    // Storage: Timestamp Now (r:1 w:0)
    fn edit_market(m: u32) -> Weight {
        Weight::from_ref_time(68_686_000)
            // Standard Error: 3_000
            .saturating_add(Weight::from_ref_time(150_000).saturating_mul(m.into()))
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    ...
    fn deploy_swap_pool_for_market_future_pool(a: u32, o: u32) -> Weight {
        Weight::from_ref_time(170_533_000)
            // Standard Error: 45_000
            .saturating_add(Weight::from_ref_time(32_842_000).saturating_mul(a.into()))
            // Standard Error: 45_000
            .saturating_add(Weight::from_ref_time(145_000).saturating_mul(o.into()))
            .saturating_add(T::DbWeight::get().reads(8))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(7))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(a.into())))
    ...
    // Storage: Swaps Pools (r:0 w:1)
    fn deploy_swap_pool_for_market_open_pool(a: u32) -> Weight {
        Weight::from_ref_time(100_840_000)
            // Standard Error: 52_000
            .saturating_add(Weight::from_ref_time(35_669_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(7))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
    ...
    // Storage: Balances Reserves (r:1 w:1)
    fn dispute_authorized() -> Weight {
        Weight::from_ref_time(73_020_000)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    // Storage: MarketCommons Markets (r:1 w:1)
    ...
    fn handle_expired_advised_market() -> Weight {
        Weight::from_ref_time(82_180_000)
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    // Storage: MarketCommons Markets (r:1 w:1)
    ...
    // Storage: PredictionMarkets Disputes (r:0 w:1)
    fn internal_resolve_categorical_reported() -> Weight {
        Weight::from_ref_time(145_420_000)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(4))
    }
    // Storage: MarketCommons Markets (r:1 w:1)
    ...
    // Storage: Swaps Pools (r:1 w:1)
    fn internal_resolve_categorical_disputed() -> Weight {
        Weight::from_ref_time(191_701_000)
            .saturating_add(T::DbWeight::get().reads(7))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    // Storage: MarketCommons Markets (r:1 w:1)
    ...
    // Storage: PredictionMarkets Disputes (r:0 w:1)
    fn internal_resolve_scalar_reported() -> Weight {
        Weight::from_ref_time(88_350_000)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    // Storage: MarketCommons Markets (r:1 w:1)
    ...
    // Storage: PredictionMarkets MarketIdsPerDisputeBlock (r:1 w:1)
    fn on_initialize_resolve_overhead() -> Weight {
        Weight::from_ref_time(38_470_000)
            .saturating_add(T::DbWeight::get().reads(9))
            .saturating_add(T::DbWeight::get().writes(8))
    }
    // Storage: PredictionMarkets MarketsCollectingSubsidy (r:1 w:1)
    fn process_subsidy_collecting_markets_raw(a: u32) -> Weight {
        Weight::from_ref_time(8_741_000)
            // Standard Error: 3_000
            .saturating_add(Weight::from_ref_time(268_000).saturating_mul(a.into()))
    ...
    // Storage: Tokens TotalIssuance (r:1 w:1)
    fn redeem_shares_categorical() -> Weight {
        Weight::from_ref_time(118_191_000)
            .saturating_add(T::DbWeight::get().reads(4))
            .saturating_add(T::DbWeight::get().writes(3))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn redeem_shares_scalar() -> Weight {
        Weight::from_ref_time(149_560_000)
    ...
    // Storage: Balances Reserves (r:1 w:1)
    // Storage: PredictionMarkets MarketIdsForEdit (r:0 w:1)
    fn reject_market(c: u32, _o: u32, r: u32) -> Weight {
        Weight::from_ref_time(126_400_000)
            // Standard Error: 4_000
            .saturating_add(Weight::from_ref_time(1_000).saturating_mul(c.into()))
            // Standard Error: 0
    ...
    fn report(_m: u32) -> Weight {
        Weight::from_ref_time(58_983_000)
            .saturating_add(T::DbWeight::get().reads(3))
            .saturating_add(T::DbWeight::get().writes(2))
    }
    // Storage: MarketCommons Markets (r:1 w:0)
    ...
    // Storage: Tokens TotalIssuance (r:2 w:2)
    fn sell_complete_set(a: u32) -> Weight {
        Weight::from_ref_time(54_681_000)
            // Standard Error: 40_000
            .saturating_add(Weight::from_ref_time(27_784_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(2))
            .saturating_add(T::DbWeight::get().reads((2_u64).saturating_mul(a.into())))
            .saturating_add(T::DbWeight::get().writes(1))
            .saturating_add(T::DbWeight::get().writes((2_u64).saturating_mul(a.into())))
    ...
    // Storage: Swaps Pools (r:0 w:1)
    fn start_subsidy(a: u32) -> Weight {
        Weight::from_ref_time(56_316_000)
            // Standard Error: 2_000
            .saturating_add(Weight::from_ref_time(110_000).saturating_mul(a.into()))
            .saturating_add(T::DbWeight::get().reads(5))
            .saturating_add(T::DbWeight::get().writes(5))
    }
    // Storage: PredictionMarkets MarketIdsPerOpenBlock (r:1 w:1)
    ...
    fn market_status_manager(b: u32, f: u32) -> Weight {
        Weight::from_ref_time(59_397_000)
            ...
            .saturating_add(Weight::from_ref_time(3_327_000).saturating_mul(b.into()))
            // Standard Error: 9_000
            .saturating_add(Weight::from_ref_time(3_297_000).saturating_mul(f.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    // Storage: PredictionMarkets MarketIdsPerDisputeBlock (r:1 w:1)
    fn market_resolution_manager(r: u32, d: u32) -> Weight {
        Weight::from_ref_time(62_079_000)
            // Standard Error: 8_000
            .saturating_add(Weight::from_ref_time(3_374_000).saturating_mul(r.into()))
            // Standard Error: 8_000
            .saturating_add(Weight::from_ref_time(3_206_000).saturating_mul(d.into()))
            .saturating_add(T::DbWeight::get().reads(2))
    ...
    // Storage: PredictionMarkets MarketsCollectingSubsidy (r:1 w:1)
    fn process_subsidy_collecting_markets_dummy() -> Weight {
        Weight::from_ref_time(7_620_000)
            .saturating_add(T::DbWeight::get().reads(1))
            .saturating_add(T::DbWeight::get().writes(1))
    }
}
